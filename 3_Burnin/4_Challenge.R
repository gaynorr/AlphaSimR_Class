...
repAYT = ??? # Represents a yield trial at ??? locations
...
for(year in 1:20){ 
  ...
  # EYT2 and select variety
  EYT2 = setPheno(EYT1, reps=???)
  
  # EYT1
  EYT1 = selectInd(AYT, nEYT)
  EYT1 = ???(EYT1, reps=repEYT)
